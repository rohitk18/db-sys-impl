...
// char *dbfile_dir = "";
char *tpch_dir = "/mnt/d/Programming/C++/CppProjects/projects/db-sys-impl/project2a/DATA/1G/";
char *dbfile_dir = "/mnt/d/Programming/C++/CppProjects/projects/db-sys-impl/project2a/DB/1G/";
